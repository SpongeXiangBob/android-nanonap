package com.zxy.nanonap.outter;
...
public class CustomBottomDialog {
    ...
    private Dialog initBottomDialog(final Builder builder) {
        ...
        View view = builder.activity.getLayoutInflater().inflate(R.layout.custom_library_bottom_dialog, null);
            ...
            vPositive.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (builder.btn_positive_callback != null)
                        builder.btn_positive_callback.onClick(CustomBottomDialog.this);
            ...
            vNegative.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (builder.btn_negative_callback != null)
                        builder.btn_negative_callback.onClick(CustomBottomDialog.this);
                    if (builder.isAutoDismiss)
                        bottomDialog.dismiss();
                }
            });
    ...
    public static class Builder {
        ...
        public CharSequence title, content;

        // Buttons
        public CharSequence btn_negative, btn_positive;
        public ButtonCallback btn_negative_callback, btn_positive_callback;
        public boolean isAutoDismiss;

        // Button text colors
        public int btn_colorNegative, btn_colorPositive;
        ...
        public int customViewPaddingLeft, customViewPaddingTop, customViewPaddingRight, customViewPaddingBottom;
        ...
        public CustomBottomDialog show() {
            CustomBottomDialog bottomDialog = build();
            bottomDialog.show();
            return bottomDialog;
        }
    ...
    public interface ButtonCallback {
        ...
        void onClick(@NonNull CustomBottomDialog dialog);
    }
